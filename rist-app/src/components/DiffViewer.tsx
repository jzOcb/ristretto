...
export const DiffViewer = ({ block }: { block: DiffBlock }) => {
  ...
  return (
    <article className="rounded-lg border border-zinc-800/60 bg-zinc-900/60">
      ...
      >
        <div>
          <p className="text-xs font-medium text-zinc-100">Diff Output</p>
      ...
      <div className="grid overflow-hidden transition-[grid-template-rows] duration-200" style={{ gridTemplateRows: open ? '1fr' : '0fr' }}>
        <div className="min-h-0">
          <pre className="overflow-x-auto border-t border-zinc-800/40 p-2.5 font-mono text-xs leading-6">
