  ...
  return (
    <main className="flex h-screen flex-col bg-zinc-950 text-zinc-100">
      ...
      <div className="relative min-h-0 flex-1 overflow-hidden px-4 py-4">
        <div className="h-full rounded-[2rem] border border-zinc-800 bg-[radial-gradient(circle_at_top_left,rgba(245,158,11,0.08),transparent_38%),linear-gradient(180deg,rgba(24,24,27,0.96),rgba(9,9,11,0.98))] p-3 shadow-[0_24px_80px_rgba(0,0,0,0.35)]">
          <div
